        ...
        <div className="flex-1 flex flex-col h-[calc(100vh-theme(spacing.16))] overflow-hidden relative bg-white dark:bg-[#0b1217] text-slate-900 dark:text-white font-display">
            ...
            <header className="h-16 flex items-center justify-between px-6 lg:px-10 border-b border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-[#0b1217]/90 backdrop-blur-md z-10 shrink-0 sticky top-0">
                <div className="flex items-center gap-3">
                    ...
                    <div className="p-2 bg-slate-100 dark:bg-slate-800 rounded-lg text-slate-500 hidden sm:block">
                ...
                <div className="max-w-3xl mx-auto space-y-10 pb-20">
                    ...
                    <section>
                        ...
                        <div className="bg-white dark:bg-[#151b26] rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
                            ...
                            <div className="bg-white dark:bg-[#151b26] border border-gray-200 dark:border-slate-800 rounded-2xl p-6 shadow-sm">
                                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
                                    <div className="w-20 h-20 bg-primary/10 rounded-full flex flex-col items-center justify-center text-primary shrink-0">
                                        <span className="material-icons text-4xl">smart_toy</span>
                                    </div>
                                    <div className="flex-1">
                                        <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Jarvis AI Assistant</h3>
                                        <p className="text-gray-500 dark:text-slate-400 max-w-lg mb-4">
                                            Your personalized AI assistant powered by advanced language models. Adjust preferences below to tailor your experience.
                                        </p>
                                        <div className="flex flex-wrap gap-2">
                                            <span className="bg-gray-100 dark:bg-slate-800 text-gray-700 dark:text-slate-300 px-3 py-1 rounded-full text-xs font-bold">Pro Plan</span>
                                            <span className="bg-emerald-50 text-emerald-600 dark:bg-emerald-900/20 dark:text-emerald-400 px-3 py-1 rounded-full text-xs font-bold flex items-center gap-1">
                                                <span className="w-1.5 h-1.5 bg-emerald-500 rounded-full"></span> System Online
                                            </span>
                                        </div>
                                    </div>
                                    <button className="px-4 py-2 bg-gray-100 dark:bg-slate-800 text-gray-700 dark:text-slate-300 rounded-xl font-medium hover:bg-gray-200 dark:hover:bg-slate-700 transition w-full sm:w-auto">
                                        Manage Account
                                    </button>
                                </div>
                            </div>
